...
static void *loadSharedObject()
{
	void *handle = dlopen("libsnes.so", RTLD_NOW);
	if (handle == NULL) {
		LOGD("Cannot load %s: %s", "libsnes.so", dlerror());
		return NULL;
	}
...
static jboolean
S9xEmulator_initialize(JNIEnv *env, jobject self)
{
    engine = (EmuEngine *) loadSharedObject();
	...
	jclass clazz = env->FindClass(
			"com/kansus/ksnes/abstractemulator/multiplayer/MultiPlayerModule$FrameUpdateListener");
...
static void
S9xEmulator_setFrameUpdateListener(JNIEnv *env, jobject self, jobject listener)
{
	pauseEmulator(env, self);
...
static void
S9xEmulator_setSurface(JNIEnv *env, jobject self, jobject surface)
{
	pauseEmulator(env, self);
...
static void
S9xEmulator_setSurfaceRegion(JNIEnv *env, jobject self,
...
static void
S9xEmulator_setKeyStates(JNIEnv *env, jobject self, jint states)
{
	keyStates = states;
}

static void
S9xEmulator_processTrackball(JNIEnv *env, jobject self,
...
static void
S9xEmulator_setOption(JNIEnv *env, jobject self, jstring jname, jstring jvalue)
{
...
static jint S9xEmulator_getOption(JNIEnv *env, jobject self, jstring jname)
{
	const char *name = env->GetStringUTFChars(jname, NULL);
...
static void S9xEmulator_getScreenshot(JNIEnv *env, jobject self, jobject jbuffer)
{
	pauseEmulator(env, self);
...
static jint S9xEmulator_getVideoWidth(JNIEnv *env, jobject self)
{
	return (currentGame ? currentGame->videoWidth : 0);
}

static jint S9xEmulator_getVideoHeight(JNIEnv *env, jobject self)
{
	return (currentGame ? currentGame->videoHeight : 0);
}

static jboolean S9xEmulator_loadROM(JNIEnv *env, jobject self, jstring jfile)
{
	unloadROM(env, self);
...
static void S9xEmulator_unloadROM(JNIEnv *env, jobject self)
{
	unloadROM(env, self);
}

static void S9xEmulator_pause(JNIEnv *env, jobject self)
{
	pauseEmulator(env, self);
	resumeRequested = false;
}

static void S9xEmulator_resume(JNIEnv *env, jobject self)
{
	resumeRequested = true;
	resumeEmulator();
}

static jboolean S9xEmulator_saveState(JNIEnv *env, jobject self, jstring jfile)
{
	const char *file = env->GetStringUTFChars(jfile, NULL);
...
static jboolean S9xEmulator_loadState(JNIEnv *env, jobject self, jstring jfile)
{
	const char *file = env->GetStringUTFChars(jfile, NULL);
...
int register_Emulator(JNIEnv *env)
{
	static const JNINativeMethod methods[] = {
		{ "setFrameUpdateListener",
				"(Lcom/kansus/ksnes/abstractemulator/multiplayer/MultiPlayerModule$FrameUpdateListener;)V",
				(void *) S9xEmulator_setFrameUpdateListener },
		{ "setSurface", "(Landroid/view/SurfaceHolder;)V",
				(void *) S9xEmulator_setSurface },
		{ "setSurfaceRegion", "(IIII)V", (void *) S9xEmulator_setSurfaceRegion },

		{ "setKeyStates", "(I)V", (void *) S9xEmulator_setKeyStates },
		{ "processTrackball", "(IIII)V", (void *) S9xEmulator_processTrackball },
		{ "fireLightGun", "(II)V", (void *) S9xEmulator_fireLightGun },
		{ "setOption", "(Ljava/lang/String;Ljava/lang/String;)V",
				(void *) S9xEmulator_setOption },
		{ "getOption", "(Ljava/lang/String;)I", (void *) S9xEmulator_getOption },

		{ "getVideoWidth", "()I", (void *) S9xEmulator_getVideoWidth },
		{ "getVideoHeight", "()I", (void *) S9xEmulator_getVideoHeight },

		{ "initialize", "()Z",
				(void *) S9xEmulator_initialize },
		{ "nativeRun", "()V", (void *) S9xEmulator_run },
		{ "nativeLoadROM", "(Ljava/lang/String;)Z", (void *) S9xEmulator_loadROM },
		{ "nativeUnloadROM", "()V", (void *) S9xEmulator_unloadROM },
		{ "reset", "()V", (void *) S9xEmulator_reset },
		{ "power", "()V", (void *) S9xEmulator_power },
		{ "pause", "()V", (void *) S9xEmulator_pause },
		{ "resume", "()V", (void *) S9xEmulator_resume },
		{ "getScreenshot", "(Ljava/nio/Buffer;)V",
				(void *) S9xEmulator_getScreenshot },
		{ "saveState", "(Ljava/lang/String;)Z", (void *) S9xEmulator_saveState },
		{ "loadState", "(Ljava/lang/String;)Z", (void *) S9xEmulator_loadState },
	};

	return jniRegisterNativeMethods(env, "com/kansus/ksnes/snes9x/S9xEmulator",
...
int register_Cheats(JNIEnv *env)
{
	...
	return jniRegisterNativeMethods(env, "com/kansus/ksnes/snes9x/S9xCheatsModule",
			methods, NELEM(methods));
}
