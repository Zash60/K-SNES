...
void S9xSwitchToFullScreen (bool8 setEnabled);
...
public:
    ...
    KeyboardSetup()
    {
        ...
        // re-setEnabled all sound channels
...
void S9xSwitchToFullScreen (bool8 setEnabled)
{
    if (XF86.full_screen_available && setEnabled != XF86.is_full_screen)
    {
	S9xTextMode ();
	XF86.is_full_screen = setEnabled;
	if (GUI.delta_screen)
	{
...
#ifdef USE_GLIDE
void S9xSwitchToGlideMode (bool8 setEnabled)
{
    S9xGlideEnable (setEnabled);
    if (Settings.GlideEnable)
