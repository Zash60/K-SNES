...
//    fprintf(stderr, "%03d: %02x to %04x\n", CPU.V_Counter, Byte, Address);
	if (Address <= 0x2183)
	{
		switch (Address)
		{
		  ...
		  case 0x2106:
			// Mosaic pixel size and setEnabled
...
//				PPU.VMA.Increment = 1;
		  ...
		  case 0x2123:
			// Window 1 and 2 setEnabled for backgrounds 1 and 2
			...
			break;
		  case 0x2124:
			// Window 1 and 2 setEnabled for backgrounds 3 and 4
			...
			break;
		  case 0x2125:
			// Window 1 and 2 setEnabled for objects and colour window
		  ...
		  case 0x2131:
			...
			{
				FLUSH_REDRAW ();
				// Backgrounds 1 - 4, objects and backdrop colour add/sub setEnabled
#ifdef DEBUGGER
				if (Byte & 0x80)
				{
					// Subtract
...
//	fprintf(stderr, "%03d: %02x to %04x\n", CPU.V_Counter, byte, Address);
	...
	if (Address < 0x4200)
	{
		...
		{
		  case 0x4200:
			// NMI, V & H IRQ and joypad reading setEnabled flags
			if (byte & 0x20)
			{
