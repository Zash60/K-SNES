...
void FxPipeString(char * pvString)
{
	...
	sprintf(p, "move r%d,r%d", USEX8(PIPE & 0x0f), (int)((int)((int)((int)((int)((int)((int)((int)((int)((int)(GSU.pvSreg - GSU.avReg)))))))))));
	...
	sprintf(p, "moves r%d,r%d", (int)((int)((int)((int)((int)((int)((int)((int)((int)((int)(GSU.pvDreg - GSU.avReg)))))))))), USEX8(PIPE & 0x0f) );
